...
namespace Win.TiendaElectronicos {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationProducto_Categoria;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationProducto_Categoria = this.Relations["Producto_Categoria"];
        }
        ...
        private void InitClass() {
            ...
            this.relationProducto_Categoria = new global::System.Data.DataRelation("Producto_Categoria", new global::System.Data.DataColumn[] {
                        this.tableProducto.IdColumn}, new global::System.Data.DataColumn[] {
                        this.tableCategoria.IdColumn}, false);
            this.Relations.Add(this.relationProducto_Categoria);
        }
        ...
        public partial class FacturaDataTable : global::System.Data.TypedTableBase<FacturaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FacturaRow AddFacturaRow(System.DateTime Fecha, string Vendedor, int ClienteId, double SubTotal, double Impuesto, double Total, bool Activo) {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, int CategoriaId, double Precio, int Inventario, byte[] Foto, bool Activo) {
        ...
        public partial class ProductoRow : global::System.Data.DataRow {
            ...
            public CategoriaRow[] GetCategoriaRows() {
                if ((this.Table.ChildRelations["Producto_Categoria"] == null)) {
                    return new CategoriaRow[0];
                }
                else {
                    return ((CategoriaRow[])(base.GetChildRows(this.Table.ChildRelations["Producto_Categoria"])));
                }
            }
        }
        ...
        public partial class CategoriaRow : global::System.Data.DataRow {
            ...
            public ProductoRow ProductoRow {
                get {
                    return ((ProductoRow)(this.GetParentRow(this.Table.ParentRelations["Producto_Categoria"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Producto_Categoria"]);
                }
            }
...
namespace Win.TiendaElectronicos.DataSet1TableAdapters {
    ...
    public partial class FacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Factura] ([Fecha], [Vendedor], [ClienteId], [SubTotal], [Impuesto], [Total], [Activo]) VALUES (@Fecha, @Vendedor, @ClienteId, @SubTotal, @Impuesto, @Total, @Activo);
SELECT Id, Fecha, Vendedor, ClienteId, SubTotal, Impuesto, Total, Activo FROM Factura WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Factura] SET [Fecha] = @Fecha, [Vendedor] = @Vendedor, [ClienteId] = @ClienteId, [SubTotal] = @SubTotal, [Impuesto] = @Impuesto, [Total] = @Total, [Activo] = @Activo WHERE (([Id] = @Original_Id) AND ([Fecha] = @Original_Fecha) AND ([ClienteId] = @Original_ClienteId) AND ([SubTotal] = @Original_SubTotal) AND ([Impuesto] = @Original_Impuesto) AND ([Total] = @Original_Total) AND ([Activo] = @Original_Activo));
SELECT Id, Fecha, Vendedor, ClienteId, SubTotal, Impuesto, Total, Activo FROM Factura WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Win.TiendaElectronicos.Properties.Settings.Default.Tecnologi_MoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Fecha, Vendedor, ClienteId, SubTotal, Impuesto, Total, Activo FROM dbo" +
                ".Factura";
        ...
        public virtual int Insert(System.DateTime Fecha, string Vendedor, int ClienteId, double SubTotal, double Impuesto, double Total, bool Activo) {
        ...
        public virtual int Update(System.DateTime Fecha, string Vendedor, int ClienteId, double SubTotal, double Impuesto, double Total, bool Activo, int Original_Id, System.DateTime Original_Fecha, int Original_ClienteId, double Original_SubTotal, double Original_Impuesto, double Original_Total, bool Original_Activo, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime Fecha, string Vendedor, int ClienteId, double SubTotal, double Impuesto, double Total, bool Activo, int Original_Id, System.DateTime Original_Fecha, int Original_ClienteId, double Original_SubTotal, double Original_Impuesto, double Original_Total, bool Original_Activo) {
            return this.Update(Fecha, Vendedor, ClienteId, SubTotal, Impuesto, Total, Activo, Original_Id, Original_Fecha, Original_ClienteId, Original_SubTotal, Original_Impuesto, Original_Total, Original_Activo, Original_Id);
        }
    }
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([Id] = @Original_Id) AND ([CategoriaId] = @O" +
                "riginal_CategoriaId) AND ([Precio] = @Original_Precio) AND ([Inventario] = @Orig" +
                "inal_Inventario) AND ([Activo] = @Original_Activo))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [CategoriaId], [Precio], [Inventario], [Foto], [Activo]) VALUES (@Descripcion, @CategoriaId, @Precio, @Inventario, @Foto, @Activo);
SELECT Id, Descripcion, CategoriaId, Precio, Inventario, Foto, Activo FROM Producto WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [CategoriaId] = @CategoriaId, [Precio] = @Precio, [Inventario] = @Inventario, [Foto] = @Foto, [Activo] = @Activo WHERE (([Id] = @Original_Id) AND ([CategoriaId] = @Original_CategoriaId) AND ([Precio] = @Original_Precio) AND ([Inventario] = @Original_Inventario) AND ([Activo] = @Original_Activo));
SELECT Id, Descripcion, CategoriaId, Precio, Inventario, Foto, Activo FROM Producto WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Descripcion, CategoriaId, Precio, Inventario, Foto, Activo FROM dbo.Pr" +
                "oducto";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, int Original_CategoriaId, double Original_Precio, int Original_Inventario, bool Original_Activo) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Descripcion, int CategoriaId, double Precio, int Inventario, byte[] Foto, bool Activo) {
            if ((Descripcion == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(Inventario));
            if ((Foto == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, int CategoriaId, double Precio, int Inventario, byte[] Foto, bool Activo, int Original_Id, int Original_CategoriaId, double Original_Precio, int Original_Inventario, bool Original_Activo, int Id) {
            if ((Descripcion == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Inventario));
            if ((Foto == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_Inventario));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, int CategoriaId, double Precio, int Inventario, byte[] Foto, bool Activo, int Original_Id, int Original_CategoriaId, double Original_Precio, int Original_Inventario, bool Original_Activo) {
            return this.Update(Descripcion, CategoriaId, Precio, Inventario, Foto, Activo, Original_Id, Original_CategoriaId, Original_Precio, Original_Inventario, Original_Activo, Original_Id);
        }
    }
